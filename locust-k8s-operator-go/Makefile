...
# io/locust-k8s-operator-go-bundle:$VERSION and io/locust-k8s-operator-go-catalog:$VERSION.
IMAGE_TAG_BASE ?= io/locust-k8s-operator-go
...
KIND_CLUSTER ?= locust-k8s-operator-go-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name locust-k8s-operator-go-builder
	$(CONTAINER_TOOL) buildx use locust-k8s-operator-go-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm locust-k8s-operator-go-builder
	rm Dockerfile.cross
